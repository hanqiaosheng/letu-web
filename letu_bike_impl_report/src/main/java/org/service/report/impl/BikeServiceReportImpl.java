...
import org.service.report.BikeServiceReport;
import org.springframework.stereotype.Service;
import org.util.DateUtil;
import org.util.PageUtil;

@Service("bikeServiceRead")
public class BikeServiceReportImpl implements BikeServiceReport {
	...
	public List<Bike> findAllBike(Integer pageIndex,Integer pageSize, Bike bike, Date bikePutStartTime, Date bikePutEndTime,
			List<Long> blockputIds, List<Long> channelIds,String bikeLockCode,Long channelid, String modelsName) throws Exception {
		...
		if (null!=modelsName&&!"".equals(modelsName)){
			criteria.andmodelsNameLike("%"+modelsName+"%");
		}
		...
		if (null != bike.getBikeId() ) {
			criteria.andBikeIdEqualTo(bike.getBikeId());
		}
	...
	@Override
	public Integer countAllBike(Bike bike, Date bikePutStartTime, Date bikePutEndTime,List<Long> blockputIds,
			List<Long> channelIds,String bikeLockCode,Long channelid, String modelsName) throws Exception {
		BikeExample bikeExample = new BikeExample();
		BikeExample.Criteria criteria = bikeExample.createCriteria();
		criteria.andBikeDelEqualTo(0);
		if (null != channelid && channelid !=-1) {
	...
	@Override
	public List<Bike> findBikeByBikeCode(String bikeCode) throws Exception {
		BikeExample bikeExample = new BikeExample();
		BikeExample.Criteria criteria = bikeExample.createCriteria();
		criteria.andBikeDelEqualTo(0);
	...
	@Override
	public List<LatLng> findByBlockIdsAndChannel(List<Long> bIds, List<Long> modelsList) throws Exception {
		// TODO Auto-generated method stub
		BikeExample bikeExample = new BikeExample();
		BikeExample.Criteria criteria = bikeExample.createCriteria();
		criteria.andBikeBlockIdIn(bIds);
