...
*/
     ...
     * @param logoPic
     */
    public static String getLogoQRCode(String qrUrl,String productName,String imgName)
    {
//      String filePath = (javax.servlet.http.HttpServletRequest)request.getSession().getServletContext().getRealPath("/") + "resources/images/logoImages/llhlogo.png";
        ...
        String filePath = "/file/letu.png";  //TODO  
        ...
        {  
            ...
            return zp.addLogo_QRCode(bim, new File(filePath), new LogoConfig(), productName,imgName);
        }
        catch (Exception e)
        {
            e.printStackTrace();
     ...
     * @param logoPic
     */
    public String addLogo_QRCode(BufferedImage bim, File logoPic, LogoConfig logoConfig, String productName,String imgName)
    {
        try
        {
            /**
...
//                  outg.drawString(productName, 0, image.getHeight() + (outImage.getHeight() - image.getHeight())/2 + 5 ); //画文字
            ...
            ImageIO.write(image, "png", new File("/file/qrcode/" + imgName + ".png")); //TODO  
