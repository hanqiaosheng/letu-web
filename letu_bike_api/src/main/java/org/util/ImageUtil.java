...
public class ImageUtil {
	...
	public static void main(String[] args) {
		...
		ImageUtil.scale2("e:/test.jpg", "e:/abc_scale3.jpg", 270, 360, false);// 测试OK
		// // 2-切割图像：
		// // 方法一：按指定起点坐标和宽高切割
		// ImageUtil.cut("e:/test.jpg", "e:/abc_cut.jpg", 0, 0, 270, 360);
		// );//测试OK
		// // 方法二：指定切片的行数和列数
	 ...
	 * @throws IOException
	 */
	public static String cutImage(String srcpath, String subpath, int x, int y, int width, int height) throws IOException {
		String imageType = null;
		int len = srcpath.indexOf("p_imgone_cut/");
		String name = subpath.substring(len);
		if (srcpath != null) {
			imageType = srcpath.substring(srcpath.lastIndexOf('.') + 1, srcpath.length());
		}
