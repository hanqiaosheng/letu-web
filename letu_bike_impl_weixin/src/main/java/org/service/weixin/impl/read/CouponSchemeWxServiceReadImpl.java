...
import org.service.weixin.read.CouponSchemeWxServiceRead;
...
@Service("couponSchemeWxServiceRead")
public class CouponSchemeWxServiceReadImpl implements CouponSchemeWxServiceRead {
    @Resource
    ...
    public List<CouponScheme> findUnionByIds(List<Long> couponSchemeIds) throws Exception {
        CouponSchemeExample example = new CouponSchemeExample();
        CouponSchemeExample.Criteria criteria = example.createCriteria();
        criteria.andPlanIdIn(couponSchemeIds);
        return couponSchemeMapper.selectUnionByExample(example);
    }
