        ...
        $.ajax({
            ...
            success: function(data) {
            	if("unlogin"==data){
            		...
            		$.confirm('您的账号已被拉黑，请联系客服电话0571-87656065',[],function(type,e){
            			if(type=='no'){
            				this.hide();	
            		    }
                ...
                if(data.message=="success"){
                    ...
                    if("goback"==options.gotourl){
                    	$.alert("充值成功,正在为您跳转",false,function(){
                    		javascript:history.go(-1);
                        },1500,{className:'ui-alert',width:300});
                    	return;
                    }
