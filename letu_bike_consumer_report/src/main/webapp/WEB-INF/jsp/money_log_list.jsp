...
<body>
	...
	<div id="page-wrapper">
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">预付款退款报表</h1>
			</div>
			<!-- /.col-lg-12 -->
			<!-- /.row -->
			<div class="row">
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading clearfix ">
                            ...
                            <br>
                            <form action="report/moneyWater/moneyLogList.action" method="post" id="searchForm">
                            ...
                            <button class="btn btn-default pull-right btn-primary" type="button" onclick="search()">查询</button>
						...
						<label style="margin-left: 20px;margin-top: 20px">预付款退款总额：</label><label><fmt:formatNumber pattern="0.00" value="${sumRefundMoney }"></fmt:formatNumber></label>元
						<!-- /.panel-heading -->
									...
									<tbody>
									     <c:forEach var="moneyLog" items="${moneyLogs }">
											<tr class="odd gradeA">
												...
												<td>
												${moneyLog.account.aUser.userTel }
												</td>
