...
<body>
	...
	<div id="page-wrapper">
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">保险费用报表</h1>
			</div>
			<!-- /.col-lg-12 -->
			<!-- /.row -->
			<div class="row">
					...
					<div class="panel panel-default">
						<div class="panel-heading clearfix ">
                            ...
                            <br>
                            	...
                            	<form action="report/moneyWater/insuranceLogList.action" method="post" id="searchForm">
						...
						<label>保险费用合计：</label><label><fmt:formatNumber pattern="0.00" value="${sumMoney }"></fmt:formatNumber></label>元
						</div>
						<!-- /.panel-heading -->
