...
<script type="text/javascript">
	...
	function checkEdit(obj){
		$.ajax({
			...
			success:function(data){
				if(data=="success"){
					window.location.href="${basePath}/cms/registplan/registPlanEditJsp.action?redeemPlanId="+obj
				}else if(data=="fail"){
...
<body>
	...
	<div id="page-wrapper">
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">注册方案列表</h1>
					...
					<div class="panel panel-default">
						<div class="panel-heading clearfix ">
                            ...
                            <div class="row tables-btn-box">
								...
								<div class="col-md-2">
                                   <span class="">注册方案名称</span>
                                   <input placeholder="注册方案名称" name="redeemPlanName" type="text" value="${redeemPlanName}" class="form-control">
                                </div> 
							</form>
                            </div>
                            <br>
							...
							<div class="row tables-action-box">
	                              	<div class="col-md-6">
	                                   <a class="btn btn-success" href="cms/registplan/registPlanJsp.action">新建注册方案</a>
	                                </div>
                           </div>
						</div>
						<!-- /.panel-heading -->
									...
									<tbody>
										<c:forEach items="${redeemPlanList }" var="redeemPlan" varStatus="varStatus">
											<tr class="odd gradeA">
												...
												<td>
												    <a class="btn btn-info" href="cms/registplan/registPlanDetail.action?redeemPlanId=${redeemPlan.planId }">详情</a>
