					...
					<div class="row">
						<div class="col-lg-6">
							...
							<input type="hidden" value="${redeemPlan.planId }" name="planId">
								...
								<label>一共兑换次数：</label>
								<div class="form-group">
									<input class="form-control" type="text" name="planRedeemNums" value="${redeemPlan.planRedeemNums }" required="required">
								</div>
								<br>
								
								<label>预定下线时间：</label>
								<div class="form-group">
									<input class="form-control" type="text" id="cEndtime" value="${redeemPlan.planRedeemNums }" name="planReserveOfflineTime">
								</div>
								<br>
								<label>绑定代金券方案：</label>
								<div class="form-group">
