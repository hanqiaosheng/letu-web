...
<div id="page-wrapper">
	<div class="row">
		<div class="col-lg-12">
			<h1 class="page-header">代金券方案编辑</h1>
		</div>
		<!-- /.col-lg-12 -->
	</div>
	<!-- /.row -->
		...
		<div class="col-lg-12">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<div class="row">
						<div class="col-lg-6">
							<form role="form" action="cms/couponplan/editCouponPlan.action"  method="post">
								<input type="hidden" name="couponPlanId" value="${couponPlan.couponPlanId }">
								<label>标题：</label>
								<div class="form-group">
									<input class="form-control cols-6" type="text" value="${couponPlan.couponPlanName }" name="couponPlanName" required="required">
								</div>
								<br>
								   ...
								   <div class="list-item clearfix">
								      ...
								      <label>绑定代金券:</label>
								         ...
								         <c:forEach items="${cashCouponList }" var="cashCoupon">
								            <option value="${cashCoupon.couponId }" <c:if test="${cashCoupon.couponId==list.cashCoupon.couponId }">selected</c:if>>${cashCoupon.couponName }</option>
								         </c:forEach>
								         </select>
								      </div>
								      <div class="form-group">
								      	<label>单次赠送数量：</label>
								         <input class="form-control" value="${list.num}" type="text" name="couponSendNums" required="required">
								      </div>
