...
<div id="page-wrapper">
	<div class="row">
		<div class="col-lg-12">
			<h1 class="page-header">兑换方案详情</h1>
		</div>
		<!-- /.col-lg-12 -->
	</div>
	<!-- /.row -->
				...
				<div class="panel-body">
					<div class="row">
						<div class="col-lg-6">
								...
								<label>一共兑换次数：</label>
								<div class="form-group">
									<input class="form-control" type="text" name="planRedeemNums" value="${redeemPlan.planRedeemNums }" readonly="readonly">
								</div>
								<br>
								<%-- <label>预定上线时间：</label>
								<div class="form-group">
									<input class="form-control" type="text" name="planReserveOnlineTime" value="${redeemPlan.planReserveOnlineTime }" readonly="readonly">
								</div>
								<br> --%>
								<label>预定下线时间：</label>
								<div class="form-group">
									<input class="form-control" type="text" name="planReserveOfflineTime" value="<fmt:formatDate value="${redeemPlan.planReserveOfflineTime }" pattern="yyyy-MM-dd HH:mm"/>" readonly="readonly">
								</div>
								<br>
								<label>绑定代金券方案：</label>
								<div class="form-group">
