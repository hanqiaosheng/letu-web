...
<body>
	...
	<div id="page-wrapper">
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">会员账户记录</h1>
			</div>
			<!-- /.col-lg-12 -->
			<!-- /.row -->
			<div class="row">
					...
					<div class="panel panel-default">
                            ...
                            <div class="row tables-btn-box">
								...
								<div class="col-md-2">
                                    ...
                                    <select class="form-control" name="moneyLogStreamType">
										...
										<option value= "2" <c:if test="${moneyLog.moneyLogStreamType==4 }">selected</c:if>>余额充值</option>
										<%-- <option value= "3" <c:if test="${moneyLog.moneyLogStreamType==3 }">selected</c:if>>押金补充</option> --%>
									</select>
                                </div> 
						...
						<div class="panel-body">
							...
							<div class="panel-heading">
								...
								<label>余额：<fmt:formatNumber pattern="0.00" value="${account.accountAvailableBalance }"/>元</label>
							</div>
										...
										<c:forEach items="${moneyLogList}" var="moneyLog">
											<tr class="odd gradeA">
												<td>
													...
													<%-- <c:if test="${moneyLog.moneyLogStreamType==4 }">押金充值</c:if> --%>
													<%-- <c:if test="${moneyLog.moneyLogStreamType==3 }">押金补充</c:if> --%>
												...
												<td>
													...
													<c:if test="${moneyLog.moneyLogOpreateId==2 }">租车消费</c:if>
													<c:if test="${moneyLog.moneyLogOpreateId==3 }">会员消费</c:if> 
													<%-- <c:if test="${moneyLog.moneyLogOpreateId==4 }">押金退款</c:if> --%>
												</td>
