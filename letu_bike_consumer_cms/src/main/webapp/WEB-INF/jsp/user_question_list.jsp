...
<body>
	...
	<div id="page-wrapper">
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">用户问题反馈</h1>
			</div>
			<!-- /.col-lg-12 -->
			<!-- /.row -->
			<div class="row">
					...
					<div class="panel panel-default">
						...
						<div class="panel-heading clearfix ">
                            ...
                            <div class="row tables-btn-box">
                            	<form action="cms/user/feedback/questionList.action" method="post" id="searchForm">
                               ...
                               <div class="col-md-2">
                                    ...
                                    <select name="feedbackTypeId" class="form-control" id="">
										...
										<option value="25" <c:if test="${feedback.feedbackTypeId==25 }">selected</c:if>>服务问题</option>
										<option value="26" <c:if test="${feedback.feedbackTypeId==26 }">selected</c:if>>系统优化</option>
                                    </select>
                                </div>
                                <div class="col-md-2">
										...
										<c:forEach items="${feedbackList}" var="feedback">
											<tr class="odd gradeA">
												...
												<td class="center">
													...
													<shiro:hasPermission name="userFeedbackAcceptButton">
														<a class="btn btn-primary"
														href="cms/user/feedback/remarkDetail1.action?feedbackId=${feedback.feedbackId }">处理</a>
													</shiro:hasPermission>
													</c:if>
