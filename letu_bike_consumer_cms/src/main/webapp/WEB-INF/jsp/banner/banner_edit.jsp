		...
		<div class="col-lg-12">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<div class="row">
						<div class="col-lg-6">
							<form role="form" action="cms/banner/editBanner.action" method="post" enctype="multipart/form-data">
							<input type="hidden" value="${banner.bannerId }" name="bannerId">
								<div class="form-group">
									<label>横幅标题：</label>
									<div class="form-group">
										<input class="form-control" placeholder="横幅标题" value="${banner.bannerName }" name="bannerName"  type="text"
											required="required">
								    </div>
									<br>
									<label>置顶号：</label>
									<div class="form-group">
										<input class="form-control" placeholder="置顶号" value="${banner.bannerTopNum }" name="bannerTopNum"  type="text"
											required="required">
								    </div>
									<br>
									<label>是否全国显示：</label>
									<input type="radio" <c:if test="${banner.bannerIsAll==1 }">checked="checked"</c:if> name="bannerIsAll" value="1"> 是
								    <input type="radio" <c:if test="${banner.bannerIsAll==0 }">checked="checked"</c:if> name="bannerIsAll" value="0"> 否
								    <br>
								    <br>
								    <label>所属城市：</label><br>
									<div class="form-group">
									   <select id="bannerCityId" class="form-control" name="bannerCityId" required="required">
			                     		<c:forEach var="city" items="${cityList}">
		                   					<option value="${city.cityId }" <c:if test="${city.cityId==banner.bannerCityId }">selected</c:if>>
		                     					${city.cityName }
			                     			</option>
			                     		</c:forEach>
		                    	       </select>
									...
									<br>
									<br>
									<label>横幅图片（请上传750像素*400像素的图片）：</label>
									<div class="form-group">
										 <div class="uploadpic">
