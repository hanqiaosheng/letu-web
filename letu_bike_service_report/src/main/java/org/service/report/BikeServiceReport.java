...
public interface BikeServiceReport {
	/**
	 * 查询所有车辆
	 * @param modelsState 
	 * @param channelId 
	 ...
	 */
     ...
     public List<Bike> findAllBike(Integer pageIndex,Integer pageSize,Bike bike,Date bikePutStartTime, Date bikePutEndTime,List<Long> blockputIds , List<Long> channelIds,String bikeLockCode,Long channelid, String modelsName) throws Exception;
     ...
     * @param channelId 
      ...
      * @throws Exception
      */
     public Integer countAllBike(Bike bike,Date bikePutStartTime, Date bikePutEndTime,List<Long> blockputIds, List<Long> channelIds,String bikeLockCode,Long channelid, String modelsName) throws Exception;
